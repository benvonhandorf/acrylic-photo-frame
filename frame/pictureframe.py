...
class PictureFrame:
  ...
  configurations = [
    ...
    ((2, 1), [((0.0, 0.75, 0.5), pushrand), #Feb 1 - Mike
      ((0.65, 1.0, 0.4), flashWhite),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), pushrand)]),
    ...
    ((6, 12), [((0.0, 0.75, 0.5), pushrand), #June 12 - William
      ((0.65, 1.0, 0.4), flashWhite),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), pushrand)]),
    ((7, 14), [((0.0, 0.75, 0.5), flashWhite), #July 14 - Oliver
      ...
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), slowFadeToWhite)]),
    ((7, 20), [((0.0, 0.75, 0.5), pushrand), #July 20 - Neal
      ((0.65, 1.0, 0.4), pushrand),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), flashWhite),
      ((0.55, 0.8, 0.4), pushrand)]),
    ((9, 3), [((0.0, 0.75, 0.5), flashWhite), #September 3 - Jasey
      ((0.65, 1.0, 0.4), pushrand),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), slowFadeToWhite)]),
    ...
    ((8, 17), [((0.0, 0.75, 0.5), pushrand), #August 17 - Maria
      ...
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), pushrand)]),
    ((10, 8), [((0.0, 0.75, 0.5), pushrand), #Oct 8 - Taunja
      ((0.65, 1.0, 0.4), pushrand),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), flashWhite)]),
    ((10, 13), [((0.0, 0.75, 0.5), pushrand), #Oct 13 - Clair
      ((0.65, 1.0, 0.4), pushrand),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), pushrand),
      ((0.55, 0.8, 0.4), slowFadeToWhite)]),
    ((10, 22), [((0.0, 0.75, 0.5), flashWhite), #Oct 22 - Jacob
      ((0.65, 1.0, 0.4), pushrand),
      ((0.33, 0.9, 0.3), pushrand),
      ((0.16, 0.8, 0.4), flashWhite),
      ((0.55, 0.8, 0.4), pushrand)]),
